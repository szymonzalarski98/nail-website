      ...
      <div className="flex flex-wrap -mx-4 center">
        ...
        <div className="md:w-1/3 px-4 md:mb-0 flex items-center">
          <p className="text-justify" style={{ textIndent: "1rem" }}>
            Nazywam się Wiktoria Grzywa, jestem magistrem kosmetologii i zajmuję
            się stylizacją paznokci. W skład mojej oferty wchodzi manicure
            hybrydowy, żelowy na naturalnej płytce, przedłużanie paznokci na
            formie, uzupełnianie żelu oraz odnowa żelu po czterech tygodniach.
