  ...
  return (
    <div>
      ...
      <div className="my-8 lg:my-12 container mx-auto flex items-center flex-col">
        ...
        <p onClick={phoneCall} className="text-center font-sans text-lg md:text-xl lg:text-2xl font-extralight cursor-pointer">Numer telefonu: +48 504573540</p>
        <p onClick={sendEmail} className="text-center font-sans text-lg md:text-xl lg:text-2xl font-extralight cursor-pointer">Adres email: wgrzywa98@gmail.com</p>
        <p onClick={openInNewTab} className="text-center font-sans text-lg md:text-xl lg:text-2xl font-extralight cursor-pointer">Instagram: @w.grzywa</p>
      </div>
      <div className="my-8 lg:my-12">
